 ...
 * <p>日志管理(档案系统)</p>
 */
@ApiModel(value = "LogDA", description = "日志管理(档案系统)")
@Data
@Accessors(chain = true)
@Document(indexName = "datai_log_da",type = "docs", shards = 1, replicas = 0)
@ExcelTarget("LogDA")
public class LogDA implements Serializable {
    ...
    public LogDA(String guid, String ip, Integer operation, Long time, String method, String params, Date operateTime, Integer status, String msg) {
        this.guid = guid;
        this.ip = ip;
